...
const { canWriteTeamScore, canAddGuestToTeam, canManageRosterMember, isFollowAlong, isFollowShowOtherOn } = require('../scoring/teamWrite');
...
router.post('/:id/team-fill', authenticate, async (req, res, next) => {
  try {
    ...
    if (memberId != null && memberId !== '') {
      ...
      if (Number(member.team_id) === Number(teamId)) {
