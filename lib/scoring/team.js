...
function joinTeamNickname(body) {
  if (!body || typeof body !== 'object') return '';
  const hasExplicit = Object.prototype.hasOwnProperty.call(body, 'teamNickname')
    || Object.prototype.hasOwnProperty.call(body, 'team_nickname');
  if (!hasExplicit) return '';
  return sanitizeNickname(body.teamNickname ?? body.team_nickname);
}
